...
$i = 0;
$table_columns[$i]['name'] = 'info_block_id';
$table_columns[$i]['text'] = 'ID';
$table_columns[$i]['column_width'] = '100';
$table_columns[$i]['in_crud'] = true;
$i++;
$table_columns[$i]['name'] = 'info_block_name';
...
$i++;
$table_columns[$i]['name'] = 'info_block_html';
...
$i++;
$table_columns[$i]['name'] = 'info_block_link';
...
$i++;
$table_columns[$i]['name'] = 'info_block_img';
$table_columns[$i]['text'] = 'Image (200 x 150)';
$table_columns[$i]['tab'] = 'main';
...
$i++;
$table_columns[$i]['name'] = 'info_block_priority';
...
$i++;
$table_columns[$i]['name'] = 'info_block_invisible';
...
$table_config['key'] = 'info_block_id';
...
$i=0;
$adv_rel_inputs[$i]['name'] = 'rel_info_block_content';
$adv_rel_inputs[$i]['input_type'] = 'many2many';
$adv_rel_inputs[$i]['text'] = 'Content';
$adv_rel_inputs[$i]['help'] = '';
$adv_rel_inputs[$i]['table'] = 'it_content';
$adv_rel_inputs[$i]['rel_table'] = 'it_rel_info_block_content';
$adv_rel_inputs[$i]['this_key'] = 'info_block_id';
$adv_rel_inputs[$i]['rel_key'] = 'info_block_id';
