...
$i = 0;
$table_columns[$i]['name'] = 'access_tables_id';
$table_columns[$i]['text'] = 'ID';
$table_columns[$i]['column_width'] = '100';
$table_columns[$i]['in_crud'] = true;
$i++;
$table_columns[$i]['name'] = 'access_tables_table_id';
$table_columns[$i]['text'] = 'Table ID';
$table_columns[$i]['tab'] = 'main';
$table_columns[$i]['input_type'] = 'text';
$table_columns[$i]['in_crud'] = true;

$i++;
$table_columns[$i]['name'] = 'access_tables_group_id';
...
$i++;
$table_columns[$i]['name'] = 'access_tables_view';
...
$i++;
$table_columns[$i]['name'] = 'access_tables_edit';
$table_columns[$i]['text'] = 'Edit Access';
$table_columns[$i]['tab'] = 'main';
$table_columns[$i]['input_type'] = 'text';
$table_columns[$i]['in_crud'] = true;

$table_config['key'] = 'access_tables_id';
