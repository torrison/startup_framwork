...
<div id="cell_tabs_<?php echo $dialog_id; ?>">
	...
	<div id="hidden">
		...
		<b>Power Data Grid Table Add Dialogs:</b>
		<br /><br /><br />
		Add info in all tabs and click "Send Add Request" Button.
		<br /><br />
	...
	?>
	<button class="btn btn-success cell_tab_submit" type="button">Add</button></div>
	</form>
</div>
