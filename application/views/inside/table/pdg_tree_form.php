<input type="hidden" id="pdg_pid" name="pdg_pid" value="<?php echo $pid;?>" />
<input type="hidden" id="pdg_ajax" name="pdg_ajax" value="" />
...
<a href="/inside/pdg_add/table_name" OnClick="return false;" style="cursor:pointer; color: #ddf;margin-left:7px;" class="btn btn-success pdg_badd"><i class="icon-plus icon-white"></i></a>
...
<input type="text" style="width:250px; margin-left: 10px;" value="" id="pdg_fsearch" name="pdg_fsearch" placeholder="Search..." />
